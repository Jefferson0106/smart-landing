 			...
 			<div class="footer-up">
 				<div class="row gy-5">
 					<div class="col-lg-3 col-md-6 col-sm-12">
 						<div class="logo">
 							<img class="robo" src="/assets/img/logo-blanco.png" alt="dustrian-logo">
 						</div>
 					...
 					<div class="col-lg-3 col-md-6 col-sm-12">
 						...
 						<ul>
 							<li>
 								...
 								<!---0router-link :to="{name:'service-details'}"><span>-</span> Mechanical Engineering</router-link>
 					...
 					<div class="col-lg-3 col-md-6">
						<div class="social-area">
 							<a href=""><i class="lab la-facebook-f" style="color: #1e90ff; font-size: 50px;"></i></a>
 							<a href=""><i class="lab la-instagram" style="color: #1e90ff; font-size: 50px;"></i></a>
 							<a href=""><i class="lab la-twitter" style="color: #1e90ff; font-size: 50px;"></i></a>
 							<!---a href=""><i class="la la-skype" style="color: white; font-size: 50px;"></i></a> -->
 						</div>
 							<!--form>
